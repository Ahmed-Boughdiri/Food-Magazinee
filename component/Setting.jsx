...
import { View, Text, TouchableOpacity, Image, StyleSheet, Dimensions, Switch } from "react-native";
...
export const Setting = ({ name, icon, last, size, switcher, touchable, eventFn, onPressEvent }) => {
    const Child = () => (
