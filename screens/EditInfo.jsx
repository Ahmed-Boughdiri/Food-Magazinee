    ...
    render() {
        return(
            <View style={styles.container}>
                <ImageBackground source={require("../assets/drawer_bg.jpg")} style={styles.profilePhoto}>
                   <View style={styles.avatar}>
                        <Text style={{textAlign: "center",color: "#fff",fontSize: 35}}>AH</Text>   
                    </View> 
                    <View style={styles.userDesc}>
                        <Text style={{textAlign: "left",color: "#000",fontSize: 18,fontWeight: "bold"}}>Ahmed Boughdiri</Text>
